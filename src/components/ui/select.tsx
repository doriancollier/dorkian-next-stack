...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-fit items-center justify-between gap-2 rounded-[var(--radius-md)] border border-input bg-background px-3.5 py-2.5 text-sm shadow-xs transition-all duration-150 ease-out",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "rounded-[var(--radius-lg)] border bg-popover text-popover-foreground shadow-floating",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2 rounded-[var(--radius-sm)] py-2 pr-8 pl-2.5 text-sm outline-hidden select-none transition-colors duration-100",
